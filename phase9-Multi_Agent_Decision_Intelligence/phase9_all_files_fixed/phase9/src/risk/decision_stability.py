...
if __name__ == "__main__":
    ...
    sys.path.insert(0, os.path.join(os.path.dirname(current_dir), "finance"))
    ...
    base = FinancialAssumptions(property_id=1, annual_operating_expenses=180000, vacancy_rate=0.05, appreciation_rate=0.08)
