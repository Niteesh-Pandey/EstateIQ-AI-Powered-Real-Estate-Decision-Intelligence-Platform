...
# Define OUT_DIR using current working directory
OUT_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.getcwd()))), "docs", "financial_results_csv")
