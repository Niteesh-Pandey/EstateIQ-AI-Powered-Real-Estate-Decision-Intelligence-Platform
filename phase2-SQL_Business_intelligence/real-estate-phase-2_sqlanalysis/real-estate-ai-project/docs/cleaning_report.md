...
## Step 3 — Parse date/month columns
  ...
  - market_monthly.month: validated as YYYY-MM text (left as-is, not converted to date)
  - economic_monthly.month: validated as YYYY-MM text (left as-is, not converted to date)
